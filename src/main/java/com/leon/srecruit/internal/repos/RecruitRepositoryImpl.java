package com.leon.srecruit.internal.repos;

import com.google.inject.Singleton;
import com.leon.srecruit.api.repos.RecruitRepository;
import com.leon.srecruit.database.JpaRepository;
...
public class RecruitRepositoryImpl extends JpaRepository<RecruitmentImpl, Long> implements RecruitRepository {
    ...
    @Override
    public Uni<List<RecruitmentImpl>> readByUserId(long userId) {
        return getSessionFactory().withTransaction((ss, tr) -> {
            ...
            return ss.createQuery(query).getResultList();
        });
    }
