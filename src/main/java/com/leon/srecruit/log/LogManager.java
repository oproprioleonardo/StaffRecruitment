...
public class LogManager {
    ...
    public void logInviteExpired(RecruitmentImpl rec, User user) {
        final TextChannel channel = Objects.requireNonNull(jda.getTextChannelById(config.getLogInviteChannelId()));
    ...
    public void logJoinEvent(User user) {
        final TextChannel channel = Objects.requireNonNull(jda.getTextChannelById(config.getLogChannelId()));
